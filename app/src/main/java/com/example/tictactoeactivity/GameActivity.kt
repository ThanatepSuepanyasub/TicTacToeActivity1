...
class GameActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        playagain = findViewById(R.id.btn_start)
    ...
    override fun onClick(view: View) {
        ...
        if (playerOneActive) {
            view.text = "O"
            view.setTextColor(Color.parseColor("#f0f9d2"))
        ...
        if (checkWinner()) {
            if (playerOneActive) {
                playerOneScoreCount++
                updatePlayerScore()
                playerStatus!!.text = "Player O Wins!"
            } else {
                playerTwoScoreCount++
                updatePlayerScore()
                playerStatus!!.text = "Player X Wins!"
            }
        } else if (rounds == 9) {
            playerStatus!!.text = "Nobody Win!"
        } else {
